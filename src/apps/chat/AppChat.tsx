 ...
 */
export type ChatModeId = 'immediate' | 'write-user' | 'react' | 'draw-imagine' | 'draw-imagine-plus' | 'bigquery';
    ...
    if (chatLLMId && focusedSystemPurposeId) {
      switch (chatModeId) {
        ...
        case 'bigquery':
          ...
          return await runBigQueryUpdatingState(conversationId, lastMessage.text, chatLLMId, getTableSchema, history, focusedSystemPurposeId);
      }
    }
